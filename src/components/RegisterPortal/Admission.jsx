...
import { 
  ...
  User, Heart, Shield, BookOpen, FileText
} from 'lucide-react';
...
function Admission() {
  ...
  const fetchStatistics = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/registrar/students/admission-stats/`, {
        headers: getAuthHeaders()
      });
  ...
  const nextStep = () => {
    if (validateStep(currentStep)) {
      ...
      addNotification('warning', 'Please fill in all required fields before proceeding.');
    }
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                      formErrors.current_class ? 'border-red-300 bg-red-50' : 'border-gray-300'
                    }`}
                  >
                    <option value="">Select Class</option>
                    {classes.map(cls => (
                      <option key={cls.id} value={cls.id}>
                        {cls.class_name} ({cls.class_code}) - Level {cls.numeric_level}
                      </option>
                    ))}
                  </select>
                  {formErrors.current_class && (
                    <p className="text-red-500 text-xs mt-1">{formErrors.current_class}</p>
                  )}
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-amber-50 rounded-lg p-5 border border-amber-200">
                <h4 className="font-semibold text-amber-800 mb-4 flex items-center">
                  ...
                  Guardian's Information <span className="text-red-500 ml-1">*</span>
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                        formErrors.guardian_relation ? 'border-red-300 bg-red-50' : 'border-gray-300'
                      }`}
                    >
                    ...
                    {formErrors.guardian_relation && (
                      <p className="text-red-500 text-xs mt-1">{formErrors.guardian_relation}</p>
                    )}
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                        formErrors.emergency_contact_name ? 'border-red-300 bg-red-50' : 'border-gray-300'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                        formErrors.emergency_contact ? 'border-red-300 bg-red-50' : 'border-gray-300'
                      }`}
                      placeholder="0712345678"
                    />
              ...
              <div className="bg-white rounded-lg p-6 border-2 border-blue-200 shadow-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-mono font-bold text-blue-700">{formData.admission_no}</span>
                  </div>
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-medium">
                      {classes.find(c => c.id == formData.current_class)?.class_name || 'Not selected'}
                    </span>
                  </div>
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg">
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                <RefreshCw className={`h-4 w-4 mr-2 ${loading.students ? 'animate-spin' : ''}`} />
                Refresh
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 md:mb-8">
          ...
          <div className="bg-white rounded-xl shadow border border-gray-200 p-4 md:p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 font-medium">Next Admission</p>
                <p className="text-2xl md:text-3xl font-bold text-gray-800 mt-2">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {students.length} students in database • {classes.length} active classes
                </p>
              </div>
            </div>
            <div className="text-right">
